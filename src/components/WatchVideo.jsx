  ...
  return (
    <div className="mt-[80px] px-12 z-10 w-screen">
      <div className="flex gap-8">
        ...
        {/* <div className="h-40 border cursor-pointer rounded-2xl" onClick={() => window.location.replace('https://www.almircollections.com')}>
          <img
          ...
          <div className="p-3 flex w-full items-center justify-between"> 
            <img className="w-10 border rounded-full" src={AdsLogo} alt="" />
