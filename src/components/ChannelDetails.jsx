    ...
    <div>
      ...
      <div className="flex justify-between max-md:flex-col">
        <div className="flex gap-2">
          <img className=" w-12" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRtRs_rWILOMx5-v3aXwJu7LWUhnPceiKvvDg&s" alt="" />
          <h1 className="whitespace-pre-wrap wrap-break-word break-all">{details.channelTitle}</h1>
          <button
        ...
        <div className="flex gap-2">
          <h1 className="flex items-center font-semibold gap-2 px-4 py-1 bg-gray-200 rounded-full">
            ...
            {counts.likeCount ? (like ? formatViews(parseInt(counts.likeCount) + 1) : formatViews(counts.likeCount)) : ""}
