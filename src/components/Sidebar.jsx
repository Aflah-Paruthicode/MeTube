...
const Sidebar = () => {
  ...
  return (
    <div className="w-56 overflow-y-scroll h-screen fixed max-md:top-0 max-md:left-0 z-20 mt-[70px] pb-[70px] bg-white">
      <Link to={"/"} className="flex gap-6 mx-5 py-2 px-2 hover:bg-[#dcdcdc] rounded-lg">
      ...
      <div className="flex gap-6 mx-5 py-2 px-2 hover:bg-[#dcdcdc] rounded-lg">
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#00000">
      ...
      {SideBarOptions.map((option, indx) => (
        <div key={indx}>
          ...
          {option.options.map((button, indx) => (
            <div key={indx} className="flex gap-6 mx-5 py-2 px-2 hover:bg-[#dcdcdc] rounded-lg cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#00000">
                <path d={button.icon} />
              </svg>
              <h1>{button.name}</h1>
