...
const Error = () => {
  return (
    <div className="w-full h-screen bg-[#f1f1f1] flex justify-center items-center flex-col">
      ...
      <Link className="font-bold border border-white p-2 rounded-lg flex items-center gap-2" to={"/"}>
        {" "}
        <span className="bg-red-500 text-white p-1 rounded-lg">Go</span> To Home
      </Link>
    </div>
  );
};
